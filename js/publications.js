            ...
            matches.forEach(match => {
                ...
                card.innerHTML = `
                    ...
                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1rem;">
                        <div class="category-tag" style="background: rgba(234, 88, 12, 0.1); color: var(--primary); padding: 4px 12px; border-radius: 20px; font-size: 0.8rem; font-weight: 700; border: 1px solid rgba(234, 88, 12, 0.2);">${match.type}</div>
